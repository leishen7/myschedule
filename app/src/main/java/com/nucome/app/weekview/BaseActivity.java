...
import com.nucome.app.crm.ServiceActivity;
import com.nucome.app.location.AndroidGPSTrackingActivity;
...
public abstract class BaseActivity extends AppCompatActivity implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.service:
                ...
                return true;
            case R.id.setting:
                Intent intent2 = new Intent(this, AndroidGPSTrackingActivity.class);
    ...
    public void onEmptyViewLongPress(Calendar time) {
        ...
        intent.putExtra(getString(R.string.EVENT_START_TIME),DateUtil.formatCalDate(time));
        Calendar endTime = (Calendar) time.clone();
        endTime.set(Calendar.HOUR, time.get(Calendar.HOUR)+1);
        intent.putExtra(getString(R.string.EVENT_END_TIME),DateUtil.formatCalDate(endTime));
        startActivity(intent);
