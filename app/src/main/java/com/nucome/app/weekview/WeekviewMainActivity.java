...
public class WeekviewMainActivity extends AppCompatActivity {
...
/*
        ...
        findViewById(R.id.buttonBasic).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeekviewMainActivity.this, BasicActivity.class);
        ...
        findViewById(R.id.buttonAsynchronous).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeekviewMainActivity.this, AsynchronousActivity.class);
                startActivity(intent);
            }
        });*/
